        ...
        return (
            <SafeAreaView style={{flex: 1, backgroundColor: colors.background}}>
                <View style={{flex: 1, justifyContent: "center", alignItems: "center", padding: 16}}>
                    <Ionicons name="person-circle-outline" size={64} color={colors.additionalText}/>
                    <Text style={{color: colors.maintext, fontSize: 18, marginTop: 16, textAlign: "center"}}>
            ...
            <ScrollView style={{flex: 1}} contentContainerStyle={{padding: 16}}>
                ...
                >
                    ...
                    {user.phone && (
                        ...
                        >
                            <Ionicons name="call-outline" size={16} color={colors.additionalText}/>
                            <Text
                                style={{
                    ...
                    <View style={{gap: 16}}>
                        ...
                        >
                            <View style={{flexDirection: "row", alignItems: "center", flex: 1}}>
                                <Ionicons name="person-outline" size={20} color={colors.additionalText}/>
                                <Text
                                    style={{
                                        color: colors.additionalText,
                                        fontSize: 14,
                        ...
                        {user.createdAt && (
                            ...
                            >
                                <View style={{flexDirection: "row", alignItems: "center", flex: 1}}>
                                    <Ionicons name="calendar-outline" size={20} color={colors.additionalText}/>
                                    <Text
                                        style={{
                                            color: colors.additionalText,
                                            fontSize: 14,
